...
###Existing MWEs: 
2- **lancé appel** (LVC), In Training Corpus
1- **mettre un terme** (ID), In Training Corpus
3- **violations exercées** (LVC)
4- **mettre un terme** (ID), In Training Corpus
###Identified MWEs: 
1- **lancé appel
2- **mettre un terme
3- **mettre un terme
...
###Existing MWEs: 
1- **il faut** (ID), In Training Corpus
2- **il faut** (ID), In Training Corpus
3- **se porte** (IReflV), In Training Corpus
###Identified MWEs: 
1- **il faut
2- **il faut
3- **se porte
##Sentence No. 14800 - fr-ud-train_13369
 Il faudra se demander si la continence parfaite des clercs n'est pas elle aussi une tradition orale ayant force d'obligation et reposant même sur l'autorité des Apôtres.
###Existing MWEs: 
2- **Il faudra** (ID), In Training Corpus
3- **se demander** (IReflV), In Training Corpus
1- **ayant force** (ID)
###Identified MWEs: 
1- **Il faudra
...
###Existing MWEs: 
1- **ont mal** (ID)
2- **se faire** (IReflV), In Training Corpus
3- **s' y prendre** (ID), In Training Corpus
###Identified MWEs: 
...
###Existing MWEs: 
1- **s' acquitter** (IReflV), In Training Corpus
...
###Existing MWEs: 
1- **Il y a** (ID), In Training Corpus
2- **commettre indélicatesse** (LVC)
3- **commettre grossièreté** (LVC), Interleaving 
###Identified MWEs: 
1- **Il y en a qui
...
###Existing MWEs: 
2- **s' éloignait** (IReflV)
1- **il y avait** (ID), In Training Corpus
###Identified MWEs: 
1- **s' éloignait
2- **il y avait
...
###Existing MWEs: 
1- **demi-finales jouent** (LVC), In Training Corpus
2- **finale jouent** (LVC), Interleaving , In Training Corpus
###Identified MWEs: 
1- **demi-finales jouent
##Sentence No. 14390 - fr-ud-train_12959
 Au cours de la saison LNH 2002-2003, il ne jouera que 8 matchs mais l'année d'après il joue tous les matchs de la franchise (avec son premier but pour son 137 match).
###Existing MWEs: 
1- **jouera matchs** (LVC), In Training Corpus
2- **joue matchs** (LVC), In Training Corpus
...
###Existing MWEs: 
1- **avoir perception** (LVC)
2- **perception ont** (LVC), Interleaving 
###Identified MWEs: 
1- **avoir perception
...
###Existing MWEs: 
2- **s' approche** (IReflV), In Training Corpus
1- **mettra des bâtons dans les roues** (ID)
###Identified MWEs: 
1- **s' approche
...
###Existing MWEs: 
1- **s' distingué** (IReflV), In Training Corpus
2- **marquant buts** (LVC)
###Identified MWEs: 
1- **s' particulièrement
##Sentence No. 14579 - fr-ud-train_13148
 Faut-il convoquer de nouveaux États généraux, représentant les provinces, ou faut-il convoquer une Assemblée nationale, représentant l'ensemble des citoyens bataves ?
###Existing MWEs: 
1- **Faut -il** (ID), In Training Corpus
2- **faut -il** (ID), In Training Corpus
###Identified MWEs: 
1- **Faut -il
2- **faut -il
...
###Existing MWEs: 
1- **Il faut** (ID), In Training Corpus
2- **remettre en cause** (ID), In Training Corpus
###Identified MWEs: 
1- **Il faut
2- **remettre en cause
##Sentence No. 14636 - fr-ud-train_13205
 Dès son plus jeune âge, sa famille se déplace à Farmington, petite ville du Minnesota, où elle grandit en menant la vie d'une sage jeune fille américaine.
###Existing MWEs: 
2- **se déplace** (IReflV), In Training Corpus
1- **menant vie** (LVC)
###Identified MWEs: 
1- **se déplace
2- **menant vie
...
###Existing MWEs: 
1- **ordre donné** (LVC), In Training Corpus
2- **s' opposé** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' opposé
...
###Existing MWEs: 
1- **prit l' air** (ID)
2- **donna satisfaction** (LVC)
###Identified MWEs: 
1- **prit l' air
##Sentence No. 14718 - fr-ud-train_13287
 Les deux ingénieurs les plus rusés s'empressent de contourner ce point du règlement en faisant en sorte que la voiture respecte ces six centimètres à l'arrêt, pour les contrôles techniques, mais pas en course.
###Existing MWEs: 
1- **s' empressent** (IReflV)
2- **faisant en sorte** (ID)
###Identified MWEs: 
1- **s' empressent
...
###Existing MWEs: 
2- **il faut** (ID), In Training Corpus
1- **subir modifications** (LVC)
###Identified MWEs: 
1- **il faut
2- **subir types
##Sentence No. 14859 - fr-ud-train_13428
 Je parle de l'isolement d'un être au sein de sa propre famille, où il est empêché d'avoir accès à lui-même, à ses contradictions, où il doit se conformer à nos soi-disant valeurs musulmanes, à notre soi-disant identité nationale.
###Existing MWEs: 
1- **avoir accès** (LVC), In Training Corpus
2- **se conformer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **avoir accès
2- **se conformer
##Sentence No. 14946 - fr-ud-train_13515
 Il était à la fois aimé, détesté et redouté, alors qu'il ne se préoccupait pas de s'assurer une fortune personnelle, le seul luxe qu'il s'accordait étant une chemise de soie confectionnée par Alexandra, et une magnifique croix également offerte par l'impératrice qu'il portait autour du cou.
###Existing MWEs: 
2- **se préoccupait** (IReflV)
1- **s' assurer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se préoccupait
2- **s' assurer
3- **s' accordait
...
###Existing MWEs: 
1- **il vaut mieux** (ID), In Training Corpus
2- **prendre précaution** (LVC)
###Identified MWEs: 
1- **il vaut mieux
2- **prendre précaution
...
###Existing MWEs: 
1- **se retrouvent** (IReflV), In Training Corpus
2- **s' annonce** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' annonce
...
###Existing MWEs: 
2- **se tiennent** (IReflV)
1- **se révèle** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se révèle
...
###Existing MWEs: 
1- **portent intérêt** (LVC)
2- **il en va** (ID), In Training Corpus
...
###Existing MWEs: 
1- **il faut** (ID), In Training Corpus
2- **garder à l' esprit** (ID), In Training Corpus
###Identified MWEs: 
1- **il faut
2- **garder à l' esprit
...
###Existing MWEs: 
1- **s' écrouler** (IReflV), In Training Corpus
2- **se écoulée** (IReflV)
###Identified MWEs: 
1- **s' écrouler
2- **se écoulée
...
###Existing MWEs: 
1- **portaient nom** (ID)
2- **eu lieu** (ID), In Training Corpus
###Identified MWEs: 
1- **eu lieu
...
###Existing MWEs: 
2- **lancera appel** (LVC)
1- **eu lieu** (ID), In Training Corpus
###Identified MWEs: 
1- **eu lieu
...
2- **prendre en photo** (LVC), In Training Corpus
...
###Existing MWEs: 
1- **en font de même** (ID)
2- **c' est à le tour** (ID), In Training Corpus
...
###Existing MWEs: 
1- **se écoulée** (IReflV)
2- **qu' importe** (ID), In Training Corpus
###Identified MWEs: 
1- **se écoulée
2- **qu' importe
...
###Existing MWEs: 
1- **prêt souscrit** (LVC)
2- **compte tenu** (ID), In Training Corpus
...
###Existing MWEs: 
2- **effectué saisons** (LVC)
1- **fait partie** (ID), In Training Corpus
###Identified MWEs: 
1- **effectué saisons
...
###Existing MWEs: 
1- **il faut** (ID), In Training Corpus
2- **s' attendre** (IReflV), In Training Corpus
###Identified MWEs: 
1- **il faut
2- **s' attendre
...
###Existing MWEs: 
1- **s' adressent** (IReflV), In Training Corpus
2- **ont possibilité** (LVC)
###Identified MWEs: 
1- **s' adressent
2- **ont possibilité
...
###Existing MWEs: 
1- **enquête menée** (LVC), In Training Corpus
2- **il n' en est rien** (ID)
###Identified MWEs: 
1- **enquête menée
...
###Existing MWEs: 
1- **Il s' agit** (ID), In Training Corpus
2- **dispositions prises** (LVC)
###Identified MWEs: 
1- **Il s' agit
...
###Existing MWEs: 
2- **don effectué** (LVC)
1- **a besoin** (LVC), In Training Corpus
###Identified MWEs: 
1- **effectué malade
2- **a besoin
...
###Existing MWEs: 
1- **s' attaquer** (IReflV), In Training Corpus
2- **s' attaquer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' attaquer
2- **s' attaquer
...
###Existing MWEs: 
2- **se perdent** (IReflV)
1- **fait part** (ID), In Training Corpus
###Identified MWEs: 
1- **se perdent
2- **fait part
...
###Existing MWEs: 
1- **s' inquiète** (IReflV), In Training Corpus
2- **répercussions avoir** (LVC)
###Identified MWEs: 
1- **s' inquiète
...
###Existing MWEs: 
1- **se suicide** (IReflV)
2- **s' agit -il** (ID), In Training Corpus
###Identified MWEs: 
1- **se suicide
2- **s' agit -il
...
###Existing MWEs: 
1- **s' imposer** (IReflV), In Training Corpus
2- **faire face** (ID), In Training Corpus
###Identified MWEs: 
1- **s' imposer
2- **faire face
...
###Existing MWEs: 
1- **ferait mieux** (ID), In Training Corpus
2- **s' abstenir** (IReflV), In Training Corpus
###Identified MWEs: 
1- **ferait mieux
2- **s' abstenir
...
###Existing MWEs: 
2- **couronner le tout** (ID), In Training Corpus
1- **eu visite** (LVC)
###Identified MWEs: 
1- **couronner le eu
...
###Existing MWEs: 
2- **porte nom** (ID), In Training Corpus
1- **portant noms** (ID)
###Identified MWEs: 
1- **porte nom
...
###Existing MWEs: 
2- **s' séparé** (IReflV), In Training Corpus
1- **reçu ordre** (LVC), In Training Corpus
###Identified MWEs: 
1- **reçu ordre
...
###Existing MWEs: 
1- **se présente** (IReflV), In Training Corpus
2- **se porte** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se présente
2- **se porte
...
###Existing MWEs: 
1- **fait partie** (ID), In Training Corpus
2- **se situe** (IReflV), In Training Corpus
###Identified MWEs: 
1- **fait partie
2- **se situe
...
###Existing MWEs: 
1- **avez envie** (LVC)
2- **laisse à désirer** (ID), In Training Corpus
###Identified MWEs: 
1- **avez envie
2- **laisse à désirer
...
###Existing MWEs: 
1- **se rend** (IReflV), In Training Corpus
2- **s' engouffre** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se rend
2- **s' engouffre
...
###Existing MWEs: 
1- **se rend compte** (ID), In Training Corpus
2- **s' aperçoit** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se rend
2- **s' aperçoit
...
###Existing MWEs: 
1- **se déroulé** (IReflV)
2- **il s' agit** (ID), In Training Corpus
###Identified MWEs: 
1- **se déroulé
2- **il s' agit
...
###Existing MWEs: 
2- **se montrent** (IReflV), In Training Corpus
1- **Il s' agit** (ID), In Training Corpus
###Identified MWEs: 
1- **se montrent
2- **Il s' agit
...
###Existing MWEs: 
1- **connut succès** (LVC), In Training Corpus
2- **faisait partie** (ID), In Training Corpus
###Identified MWEs: 
1- **connut succès
2- **faisait partie
...
###Existing MWEs: 
1- **mènent campagne** (LVC)
2- **Scellons accord** (LVC)
...
###Existing MWEs: 
1- **mesures prises** (LVC), In Training Corpus
2- **faire face** (ID), In Training Corpus
###Identified MWEs: 
1- **faire face
...
###Existing MWEs: 
1- **transformations subit** (LVC)
2- **fait référence** (LVC), In Training Corpus
###Identified MWEs: 
1- **fait référence
...
###Existing MWEs: 
1- **est l' objet** (ID), In Training Corpus
2- **est l' objet atteintes** (LVC), Interleaving 
###Identified MWEs: 
1- **est l' objet
...
###Existing MWEs: 
1- **mener à bien** (ID), In Training Corpus
2- **a besoin** (LVC), In Training Corpus
###Identified MWEs: 
1- **mener à bien
2- **a besoin
...
###Existing MWEs: 
1- **a relations** (LVC)
2- **se rendre** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se rendre
...
###Existing MWEs: 
1- **Y a -il** (ID), In Training Corpus
2- **tourner mal** (ID)
###Identified MWEs: 
1- **Y a -il
2- **tourner mal
...
###Existing MWEs: 
2- **s' fait** (IReflV), In Training Corpus
1- **s' évadés** (IReflV)
###Identified MWEs: 
1- **s' fait
2- **s' évadés
...
###Existing MWEs: 
2- **s' apprête** (IReflV), In Training Corpus
1- **Il y a** (ID), In Training Corpus
###Identified MWEs: 
1- **s' apprête
2- **Il y a
...
###Existing MWEs: 
1- **a retard** (LVC)
2- **prennent leurs precautions** (ID)
###Identified MWEs: 
1- **prennent precautions
...
###Existing MWEs: 
1- **pose problème** (ID), In Training Corpus
...
###Existing MWEs: 
1- **prendra nom** (ID), In Training Corpus
###Identified MWEs: 
1- **prendra nom
##Sentence No. 14372 - fr-ud-train_12941
 Elle révèle ensuite où se trouve Victoria Pratt, l'une des membres fondateurs de la compagnie.
###Existing MWEs: 
1- **se trouve** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se trouve
##Sentence No. 14373 - fr-ud-train_12942
 Walter Gargano dispute son premier match avec l'Uruguay en mai 2006.
###Existing MWEs: 
1- **dispute match** (LVC), In Training Corpus
###Identified MWEs: 
1- **dispute match
##Sentence No. 14375 - fr-ud-train_12944
 Il s'agissait au XVIIe siècle d'un sentier muletier servant notamment à apporter les fromages du Beaufortain sur les marchés du Piémont en empruntant ensuite le col du Mont-Cenis.
###Existing MWEs: 
1- **Il s' agissait** (ID), In Training Corpus
###Identified MWEs: 
1- **Il s' agissait
##Sentence No. 14388 - fr-ud-train_12957
 Certes, les paysages du pays des pierres (Karastan en arménien) brûlés par le soleil mettent en valeur l'attachement filial de ce peintre à son pays natal, mais il devient miroir vivifiant quand tout un peuple s'y reconnaît, au travers de puissants accords chromatiques.
###Existing MWEs: 
1- **mettent en valeur** (ID)
###Identified MWEs: 
1- **mettent en valeur
...
###Existing MWEs: 
1- **défendra couleurs** (ID)
##Sentence No. 14393 - fr-ud-train_12962
 En approchant des côtes bretonnes, les 46 solitaires de La Solitaire du Figaro doivent faire face au courant de marée montante, flot contraire qui peut atteindre plus de six nœuds en certains passages.
###Existing MWEs: 
1- **faire face** (ID), In Training Corpus
###Identified MWEs: 
1- **faire face
##Sentence No. 14396 - fr-ud-train_12965
 Une comédie romantique, ou comédie sentimentale, est un film mettant en scène de manière humoristique l'histoire d'amour (ou du moins, une partie de l'histoire d'amour) entre deux personnes.
###Existing MWEs: 
1- **mettant en scène** (ID)
###Identified MWEs: 
1- **mettant en scène
##Sentence No. 14403 - fr-ud-train_12972
 L'ensemble présente un aspect fortifié (fossés et petites ouvertures) du côté nord, qui vient en opposition avec une façade méridionale où le décor de la fin des XVe et XVIe siècles s'impose.
###Existing MWEs: 
1- **s' impose** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' impose
##Sentence No. 14412 - fr-ud-train_12981
 Il se dresse en face du col du Petit-Saint-Bernard qui fut longtemps l'un des cols les plus parcourus de Savoie.
###Existing MWEs: 
1- **se dresse** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se dresse
##Sentence No. 14415 - fr-ud-train_12984
 À 21h30, Lightoller ordonne à James Paul Moody, le sixième officier du Titanic, de téléphoner aux veilleurs du nid-de-pie, afin d'attirer leur attention sur la présence éventuelle de petits champs de glace.
###Existing MWEs: 
1- **attirer attention** (ID), In Training Corpus
###Identified MWEs: 
1- **attirer attention
##Sentence No. 14417 - fr-ud-train_12986
 Après l'assassinat de Commode en 192 et l'arrivée au pouvoir des Sévères en 193, une nouvelle conception de l'État se fait jour.
###Existing MWEs: 
1- **se fait jour** (ID)
###Identified MWEs: 
1- **fait jour
##Sentence No. 14418 - fr-ud-train_12987
 Les historiens Claude Coussement et José Gotovitch ont travaillé sur des documents de la police allemande qui les ont conduits à l'homme qui a permis aux Allemands de tendre une souricière dans la maison bruxelloise qui servait aux liaisons de Fried.
###Existing MWEs: 
1- **tendre souricière** (LVC)
...
##Sentence No. 14433 - fr-ud-train_13002
 La plainte, déposée le 16 avril 2007 à la cour fédérale de Manhattan, demandait une réparation de 150 000 $ et un rappel du matériel enfreignant le copyright.
###Existing MWEs: 
1- **plainte déposée** (LVC), In Training Corpus
...
###Existing MWEs: 
1- **porte nom** (ID), In Training Corpus
...
###Existing MWEs: 
1- **se retrouve** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se retrouve
...
###Existing MWEs: 
1- **porté plainte** (LVC), In Training Corpus
###Identified MWEs: 
1- **porté plainte
...
###Existing MWEs: 
1- **s' opposer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' opposer
...
###Existing MWEs: 
1- **prête serment** (LVC), In Training Corpus
...
###Existing MWEs: 
1- **a lieu** (ID), In Training Corpus
###Identified MWEs: 
1- **a lieu
##Sentence No. 14548 - fr-ud-train_13117
 Encore une fois, Tito s'impose par décision partagée et les critiques atteignent des sommets quand Tito prétend que Griffin aurait enduit ses jambes d'huile pour éviter les amenées au sol.
###Existing MWEs: 
1- **s' impose** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' impose
...
###Existing MWEs: 
1- **prononcera allocution** (LVC)
##Sentence No. 14571 - fr-ud-train_13140
 Dans ce contexte, Valérie Amos a remercié le Kenya et l'Ethiopie d'avoir gardé ouvertes leurs frontières avec la Somalie pour permettre aux personnes fuyant la famine de rejoindre les camps et recevoir l'assistance humanitaire.
###Existing MWEs: 
1- **recevoir assistance** (LVC)
...
###Existing MWEs: 
1- **se concentrer** (IReflV)
###Identified MWEs: 
1- **se concentrer
##Sentence No. 14575 - fr-ud-train_13144
 Au premier tercio des corridas de rejón le torero à cheval utilise des rejóns qui n'ont qu'un très lointain rapport avec les banderilles.
###Existing MWEs: 
1- **ont rapport** (LVC)
##Sentence No. 14578 - fr-ud-train_13147
 A la conférence de Paris qui s'est auto-légitimée étaient convoqués des chefs d'Etat qui n'ont jamais brillé dans la défense de la démocratie, du respect des droits de l'homme et la souveraineté nationale.
###Existing MWEs: 
1- **s' auto-légitimée** (IReflV)
###Identified MWEs: 
1- **s' auto-légitimée
##Sentence No. 14582 - fr-ud-train_13151
 Faire attention aux dates limites de consommation.
###Existing MWEs: 
1- **Faire attention** (LVC)
###Identified MWEs: 
1- **Faire attention
##Sentence No. 14591 - fr-ud-train_13160
 Petit bémol : les amateurs de vin doivent s'attendre à une addition un peu salée...
###Existing MWEs: 
1- **s' attendre** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' attendre
...
##Sentence No. 14622 - fr-ud-train_13191
 Il existe quelques outils tels que la Charte européenne des langues régionales ou minoritaires, qui protège les langues minoritaires et soutenu par la politique linguistique de l'Union européenne, qui doit faire face à l'impérialisme linguistique des langues internationales.
###Existing MWEs: 
1- **faire face** (ID), In Training Corpus
###Identified MWEs: 
1- **faire face
...
##Sentence No. 14633 - fr-ud-train_13202
 Lors de cette dernière édition, il est sacré meilleur gardien du tournoi et a sa place dans l'équipe type du tournoi.
###Existing MWEs: 
1- **a sa place** (ID)
...
###Existing MWEs: 
1- **prennent le dessus** (ID)
###Identified MWEs: 
1- **prennent le dessus
##Sentence No. 14641 - fr-ud-train_13210
 Il a grandi à partir du Scout louveteau, et a servi le mouvement de 1938 à 2005, quand il a pris sa retraite en tant que président du Gambia National Scout Council.
###Existing MWEs: 
1- **pris sa retraite** (ID)
###Identified MWEs: 
1- **pris sa retraite
##Sentence No. 14643 - fr-ud-train_13212
 Il était plus de 15 hrs ce samedi de téléthon et les restaurants ouverts se faisaient rares sur le quai du port.
###Existing MWEs: 
1- **se faisaient** (IReflV)
...
###Existing MWEs: 
1- **venir en aide** (LVC), In Training Corpus
###Identified MWEs: 
1- **venir en aide
##Sentence No. 14648 - fr-ud-train_13217
 Mais les occupants des deux étages supérieurs se sont retrouvés coincés chez eux.
###Existing MWEs: 
1- **se retrouvés** (IReflV)
...
###Existing MWEs: 
1- **remportent victoire** (LVC), In Training Corpus
###Identified MWEs: 
1- **remportent victoire
...
###Existing MWEs: 
1- **a recours** (LVC), In Training Corpus
###Identified MWEs: 
1- **a recours
...
###Existing MWEs: 
1- **eu contacts** (LVC), In Training Corpus
###Identified MWEs: 
1- **eu contacts
##Sentence No. 14693 - fr-ud-train_13262
 Vers 3h du matin, je me suis levée pour aller aux toilettes, et j'ai entendu des pas dehors.
###Existing MWEs: 
1- **me levée** (IReflV)
...
###Existing MWEs: 
1- **se situe** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se situe
##Sentence No. 14699 - fr-ud-train_13268
 L'identification avec le temple de Juturne est corroborée par un passage des Fastes d'Ovide, qui mentionne que le temple de Juturne se trouvait près du débouché de l'Aqua Virgo, près des Thermes d'Agrippa, situés juste au nord de la zone sacrée.
###Existing MWEs: 
1- **se trouvait** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se trouvait
...
##Sentence No. 14716 - fr-ud-train_13285
 Le fond est ainsi déterminé par des points discrets, en prenant en compte l'origine physique du fond et les pics d'absorption.
###Existing MWEs: 
1- **prenant en compte** (ID), In Training Corpus
###Identified MWEs: 
1- **prenant en compte
##Sentence No. 14725 - fr-ud-train_13294
 La municipalité se situe au bord de l'océan Atlantique, 25 km environ au sud du tropique du Capricorne.
###Existing MWEs: 
1- **se situe** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se situe
##Sentence No. 14736 - fr-ud-train_13305
 Le reste du personnel ne vaut pas que l'on s'en souvienne.
###Existing MWEs: 
1- **s' souvienne** (IReflV)
###Identified MWEs: 
1- **s' souvienne
...
##Sentence No. 14749 - fr-ud-train_13318
 Une disparition des dents ne peut donc absolument pas faire l'objet d'une sélection positive.
###Existing MWEs: 
1- **faire l' objet** (ID)
###Identified MWEs: 
1- **faire l' objet
##Sentence No. 14753 - fr-ud-train_13322
 Elle repousse 12 contre-attaque allemande puis entre dans Saint Lô le 18 juillet, puis prend part le 2 aout à l'offensive qui repousse les forces allemandes, hors du Cotentin, sur la Vire.
###Existing MWEs: 
1- **prend part** (ID), In Training Corpus
###Identified MWEs: 
1- **prend part
...
##Sentence No. 14760 - fr-ud-train_13329
 Elle fit ses études au Rome Centre de l'Université Loyola à Chicago.
###Existing MWEs: 
1- **fit études** (LVC)
###Identified MWEs: 
1- **fit études
...
##Sentence No. 14795 - fr-ud-train_13364
 Dès le mois d'avril, le débit baisse graduellement tout au long du printemps, pour aboutir aux basses eaux d'été qui ont lieu de juillet à septembre inclus, entraînant une baisse du débit mensuel moyen jusqu'à au mois d'août.
###Existing MWEs: 
1- **ont lieu** (ID), In Training Corpus
###Identified MWEs: 
1- **ont lieu
...
##Sentence No. 14809 - fr-ud-train_13378
 Il est d'abord considéré comme un escroc insignifiant (petty crook), mais dans les années 1950, il s'établit à Cuba, exploite un casino, s'engage dans le trafic de l'héroïne (dont il contrôle 75% de la vente, l'importation et l'exportation en Amérique du Nord) et travaille avec la French Connection.
###Existing MWEs: 
1- **s' engage** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' engage
...
###Existing MWEs: 
1- **s' éteint** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' éteint
...
###Existing MWEs: 
1- **s' arrête** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' arrête
...
###Existing MWEs: 
1- **eus l' impression** (LVC)
##Sentence No. 14850 - fr-ud-train_13419
 C'est pourquoi le positionnement d'une marque s'appuie sur les besoins, les attentes fondamentales, conscientes ou non des consommateurs définis par le marketing mix (Marketing mix).
###Existing MWEs: 
1- **s' appuie** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' appuie
##Sentence No. 14853 - fr-ud-train_13422
 Par ailleurs, le SPVM soutient qu'aux emplacements où un nombre plus important de vols de ces équipements a été noté, il y aura une présence policière accrue.
###Existing MWEs: 
1- **il y aura** (ID), In Training Corpus
###Identified MWEs: 
1- **il y aura
...
###Existing MWEs: 
1- **signera contrat** (LVC)
##Sentence No. 14872 - fr-ud-train_13441
 En effet, le stade actuel du club est quant à lui inauguré en 1985 mais rend également hommage au prince Louis II qui a permis de construire, l'ancien Stade Louis-II.
###Existing MWEs: 
1- **rend hommage** (LVC), In Training Corpus
...
##Sentence No. 14925 - fr-ud-train_13494
 J'ai également eu la chance de goûter à quelques pizzas (cuites au four à bois) et quelques entrées qui sont toutes aussi excellentes les unes que les autres.
###Existing MWEs: 
1- **eu chance** (LVC), In Training Corpus
###Identified MWEs: 
1- **eu chance
##Sentence No. 14936 - fr-ud-train_13505
 La série se compose de 113 épisodes, regroupés en 5 saisons.
###Existing MWEs: 
1- **se compose** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se compose
##Sentence No. 14942 - fr-ud-train_13511
 Plus récemment, il a travaillé derrière la caméra, en s'occupant du son sur le film Who's Your Daddy ?
###Existing MWEs: 
1- **s' occupant** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' occupant
...
###Existing MWEs: 
1- **s' efforça** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' efforça
##Sentence No. 14948 - fr-ud-train_13517
 Commune d'une centaine d'habitants qui se trouve au Sud-Ouest du département de la Somme à quelques centaines de mètres de l'Oise et quelques kilomètres de la Seine-Maritime.
###Existing MWEs: 
1- **se trouve** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se trouve
...
###Existing MWEs: 
1- **s' apparente** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' apparente
...
###Existing MWEs: 
1- **s' étend** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' étend
...
###Existing MWEs: 
1- **études menées** (LVC), In Training Corpus
...
###Existing MWEs: 
1- **sauver vie** (ID), In Training Corpus
###Identified MWEs: 
1- **sauver vie
...
###Existing MWEs: 
1- **tenant compte** (ID), In Training Corpus
###Identified MWEs: 
1- **tenant compte
...
###Existing MWEs: 
1- **s' rendu** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' rendu
...
###Existing MWEs: 
1- **tombée amoureuse** (ID), In Training Corpus
###Identified MWEs: 
1- **se tombée
...
###Existing MWEs: 
1- **entendu parler** (ID), In Training Corpus
###Identified MWEs: 
1- **entendu parler
...
###Existing MWEs: 
1- **traité signé** (LVC), In Training Corpus
###Identified MWEs: 
1- **traité signé
...
###Existing MWEs: 
1- **tournerons le dos** (ID)
##Sentence No. 15162 - fr-ud-train_13731
...
###Identified MWEs: 
1- **mit le feu
##Sentence No. 15163 - fr-ud-train_13732
...
###Existing MWEs: 
1- **se trouvent** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se trouvent
##Sentence No. 15165 - fr-ud-train_13734
 Ça ne s'arrête pas là !
###Existing MWEs: 
1- **s' arrête** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' arrête
##Sentence No. 15168 - fr-ud-train_13737
...
###Existing MWEs: 
1- **vous fiez** (IReflV), In Training Corpus
###Identified MWEs: 
1- **vous fiez
##Sentence No. 15171 - fr-ud-train_13740
...
###Identified MWEs: 
1- **il y a
##Sentence No. 15178 - fr-ud-train_13747
...
###Identified MWEs: 
1- **mettre un terme
##Sentence No. 15182 - fr-ud-train_13751
...
###Existing MWEs: 
1- **se trouvant** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se trouvant
##Sentence No. 15190 - fr-ud-train_13759
 Il est le plus jeune coureur prenant part à cette édition.
###Existing MWEs: 
1- **prenant part** (ID)
###Identified MWEs: 
1- **prenant part
##Sentence No. 15196 - fr-ud-train_13765
...
###Existing MWEs: 
1- **discussion menée** (LVC)
##Sentence No. 15205 - fr-ud-train_13774
 Elle subit de lourdes pertes pendant son repli vers Melitopol et elle est dissoute.
###Existing MWEs: 
1- **subit pertes** (LVC)
###Identified MWEs: 
1- **subit pertes
##Sentence No. 15212 - fr-ud-train_13781
...
###Existing MWEs: 
1- **se dérouler** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se dérouler
##Sentence No. 15219 - fr-ud-train_13788
 La coupe de France 2008 a eu lieu du 8 septembre 2007 au 27 avril 2008.
###Existing MWEs: 
1- **eu lieu** (ID), In Training Corpus
###Identified MWEs: 
1- **eu lieu
##Sentence No. 15225 - fr-ud-train_13794
...
###Identified MWEs: 
1- **s' articule
##Sentence No. 15236 - fr-ud-train_13805
...
1- **faire estimations
2- **il faudrait
##Sentence No. 15246 - fr-ud-train_13815
 Elle a la charge de la formation des élèves officiers.
###Existing MWEs: 
1- **a charge** (ID)
###Identified MWEs: 
1- **a formation
##Sentence No. 15252 - fr-ud-train_13821
...
###Identified MWEs: 
1- **se situe
##Sentence No. 15268 - fr-ud-train_13837
 Il se trouve dans le quartier de Fulham.
###Existing MWEs: 
1- **se trouve** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se trouve
##Sentence No. 15274 - fr-ud-train_13843
...
###Existing MWEs: 
1- **se situant** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se situant
##Sentence No. 15276 - fr-ud-train_13845
...
###Existing MWEs: 
1- **se révolte** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se révolte
##Sentence No. 15284 - fr-ud-train_13853
 Son succès a valeur de test.
###Existing MWEs: 
1- **a valeur** (ID)
##Sentence No. 15287 - fr-ud-train_13856
...
###Existing MWEs: 
1- **connaît baisse** (LVC)
##Sentence No. 15293 - fr-ud-train_13862
 Il mettra en scène la plupart de ses spectacles.
###Existing MWEs: 
1- **mettra en scène** (ID)
###Identified MWEs: 
1- **mettra en scène
##Sentence No. 15298 - fr-ud-train_13867
...
###Existing MWEs: 
1- **se tenait** (IReflV)
##Sentence No. 15307 - fr-ud-train_13876
...
###Existing MWEs: 
1- **se fait** (IReflV), In Training Corpus
##Sentence No. 15311 - fr-ud-train_13880
 Le personnel sait prendre soin de vous.
###Existing MWEs: 
1- **prendre soin** (ID)
###Identified MWEs: 
1- **prendre soin
##Sentence No. 15317 - fr-ud-train_13886
...
###Existing MWEs: 
1- **a impact** (LVC)
##Sentence No. 15318 - fr-ud-train_13887
...
###Identified MWEs: 
1- **Il y a
##Sentence No. 15326 - fr-ud-train_13895
...
###Existing MWEs: 
1- **s' évade** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' évade
##Sentence No. 15329 - fr-ud-train_13898
...
###Existing MWEs: 
1- **fait fortune** (ID), In Training Corpus
###Identified MWEs: 
1- **fait la fortune
##Sentence No. 15342 - fr-ud-train_13911
 Cordelia décide de quitter Paris, et Grace accepte de jouer le jeu et se prend pour Cordelia.
###Existing MWEs: 
1- **jouer jeu** (LVC)
##Sentence No. 15344 - fr-ud-train_13913
...
###Identified MWEs: 
1- **il faut
##Sentence No. 15369 - fr-ud-train_13938
...
###Existing MWEs: 
1- **se battrait** (IReflV)
###Identified MWEs: 
1- **se battrait
##Sentence No. 15370 - fr-ud-train_13939
...
###Existing MWEs: 
1- **mener à terme** (ID), In Training Corpus
###Identified MWEs: 
1- **mener à terme
##Sentence No. 15376 - fr-ud-train_13945
 Ava Lord est une femme fatale qui se sert de ses charmes pour assouvir ses ambitions personnelles.
###Existing MWEs: 
1- **se sert** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se sert
##Sentence No. 15383 - fr-ud-train_13952
...
###Identified MWEs: 
1- **s' en est
##Sentence No. 15385 - fr-ud-train_13954
 Entre 2004 et 2005, Nick jouait le rôle de Leslie St. Claire dans la série Charmed.
###Existing MWEs: 
1- **jouait rôle** (LVC), In Training Corpus
###Identified MWEs: 
1- **jouait rôle
##Sentence No. 15388 - fr-ud-train_13957
 ses cheveux ont grisonné, son dos s'est voûté.
###Existing MWEs: 
1- **s' voûté** (IReflV)
###Identified MWEs: 
1- **s' voûté
##Sentence No. 15389 - fr-ud-train_13958
...
###Existing MWEs: 
1- **avait tendance** (LVC)
###Identified MWEs: 
1- **il avait tendance
##Sentence No. 15392 - fr-ud-train_13961
 Il doit par ailleurs tenir compte des orientations définies par l'Agence régionale de santé.
###Existing MWEs: 
1- **tenir compte** (ID), In Training Corpus
###Identified MWEs: 
1- **tenir compte
##Sentence No. 15397 - fr-ud-train_13966
...
###Existing MWEs: 
1- **déployer efforts** (LVC)
##Sentence No. 15437 - fr-ud-train_14006
...
###Existing MWEs: 
1- **s' implantée** (IReflV)
###Identified MWEs: 
1- **s' implantée
##Sentence No. 15439 - fr-ud-train_14008
...
###Existing MWEs: 
1- **s' avérer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' avérer
##Sentence No. 15440 - fr-ud-train_14009
 Le second présente tous les matchs joués par la sélection italienne.
###Existing MWEs: 
1- **matchs joués** (LVC), In Training Corpus
###Identified MWEs: 
1- **matchs joués
##Sentence No. 15442 - fr-ud-train_14011
...
###Identified MWEs: 
1- **il s' agit
##Sentence No. 15443 - fr-ud-train_14012
...
###Existing MWEs: 
1- **prendre part** (ID), In Training Corpus
###Identified MWEs: 
1- **prendre part
##Sentence No. 15450 - fr-ud-train_14019
...
###Identified MWEs: 
1- **se situera
##Sentence No. 15460 - fr-ud-train_14029
 Mais elle va tomber amoureuse et pas de n'importe qui : de Luke...
###Existing MWEs: 
1- **tomber amoureuse** (ID)
##Sentence No. 15461 - fr-ud-train_14030
 Le lendemain, Eigigu monte sur les genoux de Maramen et tous deux s'élèvent dans les nuages.
###Existing MWEs: 
1- **s' élèvent** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' élèvent
##Sentence No. 15462 - fr-ud-train_14031
...
###Existing MWEs: 
1- **met en scène** (ID), In Training Corpus
###Identified MWEs: 
1- **met en scène
...
###Identified MWEs: 
1- **s' occupe
##Sentence No. 15467 - fr-ud-train_14036
...
###Existing MWEs: 
1- **se résigner** (IReflV)
##Sentence No. 15487 - fr-ud-train_14056
 Il a aussi recours à lHistoria ecclesiastica de Bède pour les événements jusqu'à 731.
###Existing MWEs: 
1- **a recours** (LVC), In Training Corpus
##Sentence No. 15494 - fr-ud-train_14063
 Puis, il lance l'assaut sur Korhal, mais Mengsk lui file entre les doigts au dernier moment, sauvé par Raynor.
###Existing MWEs: 
1- **lance assaut** (LVC)
###Identified MWEs: 
1- **lance assaut
##Sentence No. 15499 - fr-ud-train_14068
...
###Existing MWEs: 
1- **se composent** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se composent
##Sentence No. 15501 - fr-ud-train_14070
 Dommage, car il semble y avoir un beau potentiel.
###Existing MWEs: 
1- **il y avoir** (ID), In Training Corpus
###Identified MWEs: 
1- **il y avoir
##Sentence No. 15508 - fr-ud-train_14077
...
###Existing MWEs: 
1- **s' emparé** (IReflV), In Training Corpus
##Sentence No. 15513 - fr-ud-train_14082
...
###Identified MWEs: 
1- **se trouvent
##Sentence No. 15518 - fr-ud-train_14087
 Y a-t-il eu des réactions au niveau du Maroc ?
###Existing MWEs: 
1- **Y -il eu** (ID)
###Identified MWEs: 
1- **Y a réactions
##Sentence No. 15519 - fr-ud-train_14088
...
###Existing MWEs: 
1- **faire référence** (LVC), In Training Corpus
###Identified MWEs: 
1- **faire référence
##Sentence No. 15525 - fr-ud-train_14094
...
###Identified MWEs: 
1- **fait partie
##Sentence No. 15529 - fr-ud-train_14098
...
###Existing MWEs: 
1- **vous adresser** (IReflV)
##Sentence No. 15574 - fr-ud-train_14143
 Il se réfère aux principes édictés par l'Alliance coopérative internationale (Déclaration sur l'identité coopérative).
###Existing MWEs: 
1- **se réfère** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se réfère
##Sentence No. 15592 - fr-ud-train_14161
...
###Identified MWEs: 
1- **Il faut
2- **prendre nourriture
##Sentence No. 15597 - fr-ud-train_14166
 Sanctuaires et s (nécropoles) feront également leur apparition.
###Existing MWEs: 
1- **feront apparition** (LVC)
###Identified MWEs: 
1- **feront apparition
##Sentence No. 15606 - fr-ud-train_14175
...
###Existing MWEs: 
1- **bat en retraite** (ID)
##Sentence No. 15609 - fr-ud-train_14178
 Elle fait souvent partie de la panoplie de la mariée.
###Existing MWEs: 
1- **fait partie** (ID), In Training Corpus
###Identified MWEs: 
1- **fait partie
##Sentence No. 15611 - fr-ud-train_14180
 En 1560, la société prit part à un concours à Dixmude.
###Existing MWEs: 
1- **prit part** (ID), In Training Corpus
###Identified MWEs: 
1- **prit part
##Sentence No. 15612 - fr-ud-train_14181
...
###Existing MWEs: 
1- **s' articulent** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' articulent
##Sentence No. 15619 - fr-ud-train_14188
...
###Existing MWEs: 
1- **s' consacré** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' y est
##Sentence No. 15620 - fr-ud-train_14189
 Génie multiforme, son rôle de compositeur fait partie intégrante de son œuvre ;
###Existing MWEs: 
1- **fait partie** (ID), In Training Corpus
###Identified MWEs: 
1- **fait partie
##Sentence No. 15629 - fr-ud-train_14198
...
###Existing MWEs: 
1- **s' appuyant** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' appuyant
##Sentence No. 15650 - fr-ud-train_14219
...
###Existing MWEs: 
1- **faire en sorte** (ID)
##Sentence No. 15653 - fr-ud-train_14222
...
###Identified MWEs: 
1- **avait emportées
##Sentence No. 15657 - fr-ud-train_14226
 Ils attiraient le voyageur dans l'eau et le noyaient, avant de se moquer de lui en dansant sur son cadavre.
###Existing MWEs: 
1- **se moquer** (IReflV)
###Identified MWEs: 
1- **se moquer
##Sentence No. 15662 - fr-ud-train_14231
 Avant de me rendre dans les camps, j'ai rencontré un représentant du Front Polisario à Londres qui m'a dit : « les camps sont l'un des endroits les plus sûrs de cette planète ».
###Existing MWEs: 
1- **me rendre** (IReflV)
###Identified MWEs: 
1- **me rendre
##Sentence No. 15673 - fr-ud-train_14242
...
###Existing MWEs: 
1- **poser question** (LVC), In Training Corpus
###Identified MWEs: 
1- **poser question
##Sentence No. 15686 - fr-ud-train_14255
...
###Existing MWEs: 
1- **se dirige** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se dirige
##Sentence No. 15733 - fr-ud-train_14302
...
###Existing MWEs: 
1- **s' inspire** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' inspire
##Sentence No. 15745 - fr-ud-train_14314
 La transaction finale devrait avoir lieu le 2 mai, la certification unique étant espérée pour le début 2012.
###Existing MWEs: 
1- **avoir lieu** (ID), In Training Corpus
###Identified MWEs: 
1- **avoir lieu
##Sentence No. 15748 - fr-ud-train_14317
...
###Existing MWEs: 
1- **livré bataille** (LVC)
##Sentence No. 15749 - fr-ud-train_14318
...
###Existing MWEs: 
1- **se voient** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se voient
##Sentence No. 15769 - fr-ud-train_14338
 A l'intérieur du donjon se dressent de gros piliers de bois.
###Existing MWEs: 
1- **se dressent** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se dressent
##Sentence No. 15782 - fr-ud-train_14351
 Elle faisait partie avant cela du département de l'Ourthe.
###Existing MWEs: 
1- **faisait partie** (ID), In Training Corpus
###Identified MWEs: 
1- **faisait partie
##Sentence No. 15785 - fr-ud-train_14354
...
###Existing MWEs: 
1- **présente avantages** (LVC)
##Sentence No. 15792 - fr-ud-train_14361
...
###Existing MWEs: 
1- **match disputé** (LVC), In Training Corpus
##Sentence No. 15870 - fr-ud-train_14439
...
###Existing MWEs: 
1- **fait appel** (LVC), In Training Corpus
###Identified MWEs: 
1- **fait appel
##Sentence No. 15873 - fr-ud-train_14442
...
###Existing MWEs: 
1- **se rétablir** (IReflV)
##Sentence No. 15892 - fr-ud-train_14461
...
###Existing MWEs: 
1- **se déroulait** (IReflV)
###Identified MWEs: 
1- **se déroulait
##Sentence No. 15893 - fr-ud-train_14462
 Le remorquage à proprement parler s'est très bien passé.
###Existing MWEs: 
1- **s' passé** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' passé
##Sentence No. 15901 - fr-ud-train_14470
...
###Identified MWEs: 
1- **s' emparé
##Sentence No. 15915 - fr-ud-train_14484
...
###Existing MWEs: 
1- **ont besoin** (LVC), In Training Corpus
###Identified MWEs: 
1- **ont besoin
##Sentence No. 15919 - fr-ud-train_14488
...
###Existing MWEs: 
1- **fait prisonniers** (ID), In Training Corpus
###Identified MWEs: 
1- **fait prisonniers
##Sentence No. 15971 - fr-ud-train_14540
...
###Existing MWEs: 
1- **obtient succès** (LVC), In Training Corpus
##Sentence No. 15974 - fr-ud-train_14543
...
###Existing MWEs: 
1- **fait l' objet** (ID), In Training Corpus
##Sentence No. 16003 - fr-ud-dev_00018
...
###Identified MWEs: 
1- **s' appuyait
##Sentence No. 16005 - fr-ud-dev_00020
...
###Identified MWEs: 
1- **se révèle
##Sentence No. 16006 - fr-ud-dev_00021
...
###Existing MWEs: 
1- **ont positions** (LVC)
##Sentence No. 16066 - fr-ud-dev_00081
...
###Existing MWEs: 
1- **a but** (LVC), In Training Corpus
###Identified MWEs: 
1- **a but
##Sentence No. 16068 - fr-ud-dev_00083
 En juillet 1941, une première attaque aérienne s'abattit sur la ville, quatre autres suivirent.
###Existing MWEs: 
1- **s' abattit** (IReflV)
###Identified MWEs: 
1- **s' abattit
##Sentence No. 16069 - fr-ud-dev_00084
...
###Existing MWEs: 
1- **il fallait** (ID), In Training Corpus
###Identified MWEs: 
1- **il fallait
...
###Existing MWEs: 
1- **alliance scelle** (LVC)
##Sentence No. 16095 - fr-ud-dev_00110
 De plus, elles n'ont eu aucun impact manifeste sur les populations d'Achatines.
###Existing MWEs: 
1- **eu impact** (LVC), In Training Corpus
###Identified MWEs: 
1- **eu impact
##Sentence No. 16101 - fr-ud-dev_00116
...
###Identified MWEs: 
1- **avoir lieu
##Sentence No. 16123 - fr-ud-dev_00138
...
###Existing MWEs: 
1- **rôle assumer** (LVC)
##Sentence No. 16125 - fr-ud-dev_00140
...
###Identified MWEs: 
1- **tenu parole
##Sentence No. 16129 - fr-ud-dev_00144
...
###Existing MWEs: 
1- **se tient** (IReflV), In Training Corpus
##Sentence No. 16140 - fr-ud-dev_00155
...
###Identified MWEs: 
1- **il s' agit
##Sentence No. 16155 - fr-ud-dev_00170
...
###Existing MWEs: 
1- **eut effet** (LVC)
##Sentence No. 16162 - fr-ud-dev_00177
...
###Existing MWEs: 
1- **se retirer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se retirer
##Sentence No. 16163 - fr-ud-dev_00178
...
###Existing MWEs: 
1- **prend sa source** (ID), In Training Corpus
###Identified MWEs: 
1- **prend sa source
##Sentence No. 16178 - fr-ud-dev_00193
...
###Existing MWEs: 
1- **remporté succès** (LVC)
##Sentence No. 16181 - fr-ud-dev_00196
 Celui-ci fait 5 000 morts mais s'arrête juste devant une petite chapelle dédiée à Marie.
###Existing MWEs: 
1- **s' arrête** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' arrête
##Sentence No. 16187 - fr-ud-dev_00202
...
###Identified MWEs: 
1- **fait appel
##Sentence No. 16192 - fr-ud-dev_00207
...
###Identified MWEs: 
1- **s' étend
##Sentence No. 16222 - fr-ud-dev_00237
...
###Existing MWEs: 
1- **présentant adaptations** (LVC)
###Identified MWEs: 
1- **présentant adaptations
##Sentence No. 16225 - fr-ud-dev_00240
...
###Existing MWEs: 
1- **se vit** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se vit
##Sentence No. 16237 - fr-ud-dev_00252
...
###Identified MWEs: 
1- **se trouve
##Sentence No. 16243 - fr-ud-dev_00258
...
###Existing MWEs: 
1- **donne récit** (LVC)
##Sentence No. 16244 - fr-ud-dev_00259
...
##Sentence No. 16261 - fr-ud-dev_00276
...
###Existing MWEs: 
1- **mis en œuvre** (ID), In Training Corpus
###Identified MWEs: 
1- **mis en œuvre
##Sentence No. 16264 - fr-ud-dev_00279
 Il joua à la Sampdoria, à la Juventus (pour qui il joua son premier match le 6 novembre 1960 lors d'une défaite contre le Milan 4-3 en Serie A) et au Milan AC, remportant des titres au niveaux national et européen.
###Existing MWEs: 
1- **joua match** (LVC)
##Sentence No. 16266 - fr-ud-dev_00281
 MG, le personnage principal, écrit un journal et fait part de ses états d'âmes d'écrivain riche et célèbre à l'âge avancé.
###Existing MWEs: 
1- **fait part** (ID), In Training Corpus
###Identified MWEs: 
1- **fait part
##Sentence No. 16267 - fr-ud-dev_00282
...
###Existing MWEs: 
1- **se produisit** (IReflV)
###Identified MWEs: 
1- **se produisit
##Sentence No. 16272 - fr-ud-dev_00287
 Livré aux Britanniques et adaptés par eux, le M10 prit le nom dAchilles.
###Existing MWEs: 
1- **prit nom** (ID), In Training Corpus
###Identified MWEs: 
1- **prit nom
##Sentence No. 16273 - fr-ud-dev_00288
...
###Identified MWEs: 
1- **fait parti
##Sentence No. 16327 - fr-ud-dev_00342
...
###Identified MWEs: 
1- **il s' agit
##Sentence No. 16342 - fr-ud-dev_00357
...
###Existing MWEs: 
1- **rôle joué** (LVC), In Training Corpus
###Identified MWEs: 
1- **rôle joué
##Sentence No. 16348 - fr-ud-dev_00363
...
###Existing MWEs: 
1- **dispute parties** (LVC)
###Identified MWEs: 
1- **dispute parties
##Sentence No. 16356 - fr-ud-dev_00371
...
###Identified MWEs: 
1- **Il s' agit
##Sentence No. 16369 - fr-ud-dev_00384
...
###Existing MWEs: 
1- **se conformer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se conformer
##Sentence No. 16374 - fr-ud-dev_00389
...
###Identified MWEs: 
1- **se trouve
##Sentence No. 16376 - fr-ud-dev_00391
...
###Identified MWEs: 
1- **eu carrière
##Sentence No. 16399 - fr-ud-dev_00414
...
###Existing MWEs: 
1- **se soucier** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se soucier
##Sentence No. 16409 - fr-ud-dev_00424
...
###Existing MWEs: 
1- **se porte** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se porte
##Sentence No. 16411 - fr-ud-dev_00426
 Il y avait près de 1000 personnes au lancement de l'événement à l'Arsenal, le 8 septembre.
###Existing MWEs: 
1- **Il y avait** (ID), In Training Corpus
###Identified MWEs: 
1- **Il y avait
##Sentence No. 16412 - fr-ud-dev_00427
 « Est-ce qu'il y a un poème ce matin ?
###Existing MWEs: 
1- **il y a** (ID), In Training Corpus
###Identified MWEs: 
1- **il y a
##Sentence No. 16413 - fr-ud-dev_00428
...
##Sentence No. 16438 - fr-ud-dev_00453
 Il fait partie de la section de Nobressart.
###Existing MWEs: 
1- **fait partie** (ID), In Training Corpus
###Identified MWEs: 
1- **fait partie
##Sentence No. 16440 - fr-ud-dev_00455
...
1- **se rend
2- **signer paix
##Sentence No. 16441 - fr-ud-dev_00456
...
###Existing MWEs: 
1- **s' adapter** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' adapter
##Sentence No. 16453 - fr-ud-dev_00468
...
###Identified MWEs: 
1- **font écho
##Sentence No. 16483 - fr-ud-dev_00498
...
###Existing MWEs: 
1- **connaît retards** (LVC)
##Sentence No. 16489 - fr-ud-dev_00504
...
###Existing MWEs: 
1- **signé conventions** (LVC)
##Sentence No. 16492 - fr-ud-dev_00507
...
###Existing MWEs: 
1- **connu soucis** (LVC)
##Sentence No. 16495 - fr-ud-dev_00510
...
###Identified MWEs: 
1- **fait partie
##Sentence No. 16497 - fr-ud-dev_00512
...
###Identified MWEs: 
1- **s' entendre
##Sentence No. 16527 - fr-ud-dev_00542
...
###Existing MWEs: 
1- **se distinguent** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se distinguent
##Sentence No. 16555 - fr-ud-dev_00570
...
###Identified MWEs: 
1- **s' illustra
##Sentence No. 16557 - fr-ud-dev_00572
...
###Existing MWEs: 
1- **pris part** (ID), In Training Corpus
###Identified MWEs: 
1- **pris part
##Sentence No. 16559 - fr-ud-dev_00574
...
###Existing MWEs: 
1- **exercice pratique** (LVC)
##Sentence No. 16571 - fr-ud-dev_00586
 Son siège social se trouve à Londres, au Royaume-Uni.
###Existing MWEs: 
1- **se trouve** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se trouve
##Sentence No. 16578 - fr-ud-dev_00593
 La dernière émission de Lollipop portait le nom de Waterloollipop.
###Existing MWEs: 
1- **portait nom** (ID)
##Sentence No. 16580 - fr-ud-dev_00595
...
###Existing MWEs: 
1- **font partie** (ID), In Training Corpus
##Sentence No. 16590 - fr-ud-dev_00605
 L'investissement peut alors se faire en masse sur un grand nombre de valeurs (effet grégaire).
###Existing MWEs: 
1- **investissement faire** (LVC)
##Sentence No. 16591 - fr-ud-dev_00606
...
###Existing MWEs: 
1- **prendre succession** (LVC)
###Identified MWEs: 
1- **prendre succession
##Sentence No. 16626 - fr-ud-dev_00641
...
###Existing MWEs: 
1- **tirer parti** (ID)
##Sentence No. 16631 - fr-ud-dev_00646
...
###Identified MWEs: 
1- **se situe
##Sentence No. 16638 - fr-ud-dev_00653
...
###Identified MWEs: 
1- **il y avait
##Sentence No. 16663 - fr-ud-dev_00678
...
###Existing MWEs: 
1- **réalise expositions** (LVC)
##Sentence No. 16669 - fr-ud-dev_00684
...
###Existing MWEs: 
1- **prennent leur distance** (ID)
###Identified MWEs: 
1- **prennent distance
##Sentence No. 16671 - fr-ud-dev_00686
 La longueur du module M n'est autre que sa longueur comme groupe à opérateurs.
###Existing MWEs: 
1- **n' est autre que** (ID), In Training Corpus
##Sentence No. 16673 - fr-ud-dev_00688
...
###Existing MWEs: 
1- **sondage réalisé** (LVC)
###Identified MWEs: 
1- **obtient indice
##Sentence No. 16676 - fr-ud-dev_00691
...
###Existing MWEs: 
1- **reçut éducation** (LVC), In Training Corpus
###Identified MWEs: 
1- **reçut élémentaire
##Sentence No. 16685 - fr-ud-dev_00700
 Il est nécessaire de remettre tout cela en état, et de virer le personnel sale et incompétent.
###Existing MWEs: 
1- **remettre en état** (ID), In Training Corpus
##Sentence No. 16691 - fr-ud-dev_00706
 C'est alors qu'il prend ses distances avec la droite pour se rallier définitivement au camp républicain.
###Existing MWEs: 
1- **prend ses distances** (ID)
###Identified MWEs: 
1- **prend distances
##Sentence No. 16692 - fr-ud-dev_00707
...
###Identified MWEs: 
1- **s' engagée
##Sentence No. 16757 - fr-ud-dev_00772
...
###Existing MWEs: 
1- **se consacrer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se consacrer
##Sentence No. 16761 - fr-ud-dev_00776
 Il s'agit du premier Bound for Glory, évènement est le plus important de la TNA.
###Existing MWEs: 
1- **Il s' agit** (ID), In Training Corpus
###Identified MWEs: 
1- **Il s' agit
##Sentence No. 16762 - fr-ud-dev_00777
 Il a fallu 33 jours de forage pour atteindre les 33 mineurs.
###Existing MWEs: 
1- **Il fallu** (ID), In Training Corpus
###Identified MWEs: 
1- **Il fallu
##Sentence No. 16766 - fr-ud-dev_00781
 Une bonne raison pour faire un détour à saint Jean de Maurienne.
###Existing MWEs: 
1- **faire détour** (LVC)
###Identified MWEs: 
1- **faire détour
##Sentence No. 16777 - fr-ud-dev_00792
...
###Existing MWEs: 
1- **se référant** (IReflV)
###Identified MWEs: 
1- **se référant
##Sentence No. 16778 - fr-ud-dev_00793
...
###Existing MWEs: 
1- **prend en compte** (ID), In Training Corpus
###Identified MWEs: 
1- **prend en compte
##Sentence No. 16779 - fr-ud-dev_00794
 Elle se situe à une altitude de 483 mètres.
###Existing MWEs: 
1- **se situe** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se situe
##Sentence No. 16783 - fr-ud-dev_00798
 C'est un match qui fait partie de leur formation.
###Existing MWEs: 
1- **fait partie** (ID), In Training Corpus
###Identified MWEs: 
1- **fait partie
##Sentence No. 16786 - fr-ud-dev_00801
...
###Existing MWEs: 
1- **mettent en cause** (ID)
###Identified MWEs: 
1- **mettent en cause
##Sentence No. 16787 - fr-ud-dev_00802
...
###Existing MWEs: 
1- **se balader** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se balader
##Sentence No. 16795 - fr-ud-dev_00810
...
###Existing MWEs: 
1- **travaux réalisés** (LVC), In Training Corpus
###Identified MWEs: 
1- **travaux réalisés
##Sentence No. 16802 - fr-ud-dev_00817
...
###Existing MWEs: 
1- **jouer la montre** (ID)
##Sentence No. 16803 - fr-ud-dev_00818
...
###Existing MWEs: 
1- **redonnant confiance** (ID)
##Sentence No. 16804 - fr-ud-dev_00819
...
###Existing MWEs: 
1- **réalisera augmentation** (LVC)
##Sentence No. 16810 - fr-ud-dev_00825
 Dans le même temps, les sports populaires connaissent un important développement et concurrencent les castells.
###Existing MWEs: 
1- **connaissent développement** (LVC)
##Sentence No. 16825 - fr-ud-dev_00840
 Avant l'essor de la médecine, les accouchements se déroulaient au domicile de la femme parturiente.
###Existing MWEs: 
1- **se déroulaient** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se déroulaient
##Sentence No. 16840 - fr-ud-dev_00855
 Il se voit obligé de se transformer en Ultimate Echo Echo pour les terrasser.
###Existing MWEs: 
1- **se voit** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se voit
##Sentence No. 16844 - fr-ud-dev_00859
 La 60e cérémonie des Primetime Emmy Awards, organisée par l'Académie des arts et des sciences de la télévision et récompensant les séries télévisées diffusées au cours de la saison 2007-2008, s'est déroulée le 21 septembre 2008 au Nokia Theater de Los Angeles.
###Existing MWEs: 
1- **s' déroulée** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' déroulée
##Sentence No. 16861 - fr-ud-dev_00876
...
###Existing MWEs: 
1- **se doit** (IReflV), In Training Corpus
##Sentence No. 16877 - fr-ud-dev_00892
...
###Existing MWEs: 
1- **se situent** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se situent
##Sentence No. 16878 - fr-ud-dev_00893
 Une partie du forum s'écroule au IXe siècle à la suite d'un glissement de terrain.
###Existing MWEs: 
1- **s' écroule** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' écroule
##Sentence No. 16882 - fr-ud-dev_00897
...
###Identified MWEs: 
1- **se situe
##Sentence No. 16883 - fr-ud-dev_00898
...
###Identified MWEs: 
1- **Il s' agit
##Sentence No. 16884 - fr-ud-dev_00899
...
###Identified MWEs: 
1- **rendu visite
##Sentence No. 16887 - fr-ud-dev_00902
...
###Existing MWEs: 
1- **se déroulées** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se déroulées
##Sentence No. 16890 - fr-ud-dev_00905
...
###Existing MWEs: 
1- **a besoin** (LVC), In Training Corpus
##Sentence No. 16896 - fr-ud-dev_00911
 Bent présente ses excuses peu de temps après.
###Existing MWEs: 
1- **présente excuses** (LVC)
...
###Identified MWEs: 
1- **il s' agit
##Sentence No. 16904 - fr-ud-dev_00919
...
###Existing MWEs: 
1- **se contenter** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se contenter
##Sentence No. 16907 - fr-ud-dev_00922
...
###Existing MWEs: 
1- **fait apparition** (LVC), In Training Corpus
###Identified MWEs: 
1- **fait apparition
##Sentence No. 16922 - fr-ud-dev_00937
...
1- **prit nom** (ID), In Training Corpus
###Identified MWEs: 
1- **prit en conséquence
##Sentence No. 16954 - fr-ud-dev_00969
 Il se prélasse au soleil, souvent avec son corps aligné parallèlement aux rayons du soleil.
###Existing MWEs: 
1- **se prélasse** (IReflV)
###Identified MWEs: 
1- **se prélasse
##Sentence No. 16959 - fr-ud-dev_00974
...
###Identified MWEs: 
1- **a lieu
2- **accomplit exclusivement
##Sentence No. 16968 - fr-ud-dev_00983
 Il fait partie des clubs fondateurs du deuxième niveau national, baptisé Promotion, en 1909.
###Existing MWEs: 
1- **fait partie** (ID), In Training Corpus
###Identified MWEs: 
1- **fait partie
##Sentence No. 16969 - fr-ud-dev_00984
...
###Existing MWEs: 
1- **s' allongeant** (IReflV)
##Sentence No. 16980 - fr-ud-dev_00995
...
###Existing MWEs: 
1- **mise en œuvre** (ID), In Training Corpus
###Identified MWEs: 
1- **mise en œuvre
##Sentence No. 16987 - fr-ud-dev_01002
...
###Existing MWEs: 
1- **prodiguant soins** (LVC)
###Identified MWEs: 
1- **s' transformé
##Sentence No. 16990 - fr-ud-dev_01005
...
###Existing MWEs: 
1- **se déroule** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se déroule
##Sentence No. 16997 - fr-ud-dev_01012
 Le procès a mal tourné.
###Existing MWEs: 
1- **mal tourné** (ID)
###Identified MWEs: 
1- **a mal
##Sentence No. 17002 - fr-ud-dev_01017
...
###Existing MWEs: 
1- **avoir significations** (LVC)
###Identified MWEs: 
1- **avoir significations
##Sentence No. 17030 - fr-ud-dev_01045
...
###Existing MWEs: 
1- **firent appel** (LVC), In Training Corpus
###Identified MWEs: 
1- **firent appel
##Sentence No. 17048 - fr-ud-dev_01063
 Quand on hésite, pas de panique, Michelle est là pour nous donner de précieux conseils.
###Existing MWEs: 
1- **donner conseils** (LVC)
##Sentence No. 17051 - fr-ud-dev_01066
...
###Identified MWEs: 
1- **se retire
##Sentence No. 17059 - fr-ud-dev_01074
...
###Existing MWEs: 
1- **conférence de presse tenue** (LVC)
##Sentence No. 17061 - fr-ud-dev_01076
 Au cœur du bourg se trouve une plaza Mayor à arcades, ombragée et fleurie.
###Existing MWEs: 
1- **se trouve** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se trouve
##Sentence No. 17062 - fr-ud-dev_01077
 Quant à Francis Wolff, il réalisait les photographies pour les pochettes des disques.
###Existing MWEs: 
1- **réalisait photographies** (LVC)
##Sentence No. 17068 - fr-ud-dev_01083
...
###Existing MWEs: 
1- **a sensibilité** (LVC)
##Sentence No. 17100 - fr-ud-dev_01115
 Les représentants des médias sont invités à se joindre à l'événement.
###Existing MWEs: 
1- **se joindre** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se joindre
##Sentence No. 17101 - fr-ud-dev_01116
...
###Existing MWEs: 
1- **il y avoir** (ID), In Training Corpus
##Sentence No. 17104 - fr-ud-dev_01119
...
###Existing MWEs: 
1- **s' prononcé** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' prononcé
##Sentence No. 17106 - fr-ud-dev_01121
...
###Existing MWEs: 
1- **fait montre** (ID)
##Sentence No. 17173 - fr-ud-dev_01188
...
###Existing MWEs: 
1- **se classant** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se classant
##Sentence No. 17176 - fr-ud-dev_01191
...
###Existing MWEs: 
1- **cloués à le sol** (ID)
##Sentence No. 17195 - fr-ud-dev_01210
...
###Existing MWEs: 
1- **se rapprochent** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se rapprochent
##Sentence No. 17210 - fr-ud-dev_01225
...
1- **il faut
2- **s' étonner
##Sentence No. 17219 - fr-ud-dev_01234
...
###Existing MWEs: 
1- **faire partie** (ID), In Training Corpus
###Identified MWEs: 
1- **exercer fonctions
2- **faire partie
##Sentence No. 17223 - fr-ud-dev_01238
...
###Existing MWEs: 
1- **séparer le grain de l' ivraie** (ID)
##Sentence No. 17227 - fr-ud-dev_01242
...
###Existing MWEs: 
1- **inscrit but** (LVC), In Training Corpus
##Sentence No. 17232 - fr-ud-dev_01247
...
###Existing MWEs: 
1- **lut dans pensées** (ID)
##Sentence No. 17242 - fr-ud-dev_01257
 Nasser est pris au piège et il entre en conflit avec l'Arabie saoudite.
###Existing MWEs: 
1- **pris à le piège** (ID), In Training Corpus
###Identified MWEs: 
1- **pris à le piège
...
###Existing MWEs: 
1- **eu résultat** (LVC), In Training Corpus
###Identified MWEs: 
1- **fit morts
2- **eu résultat
##Sentence No. 17251 - fr-ud-dev_01266
...
###Existing MWEs: 
1- **Compte tenu** (ID), In Training Corpus
##Sentence No. 17255 - fr-ud-dev_01270
...
###Identified MWEs: 
1- **il s' agit
##Sentence No. 17264 - fr-ud-dev_01279
...
###Existing MWEs: 
1- **fit apparition** (LVC)
##Sentence No. 17306 - fr-ud-dev_01321
...
###Identified MWEs: 
1- **Il s' agit
##Sentence No. 17344 - fr-ud-dev_01359
...
###Identified MWEs: 
1- **mettre la pâté
##Sentence No. 17361 - fr-ud-dev_01376
...
###Identified MWEs: 
1- **eu lieu
##Sentence No. 17362 - fr-ud-dev_01377
...
###Identified MWEs: 
1- **se déroule
##Sentence No. 17366 - fr-ud-dev_01381
...
###Identified MWEs: 
1- **se situe
##Sentence No. 17386 - fr-ud-dev_01401
...
###Existing MWEs: 
1- **dispense enseignement** (LVC)
##Sentence No. 17387 - fr-ud-dev_01402
...
###Existing MWEs: 
1- **jouer rôle** (LVC), In Training Corpus
###Identified MWEs: 
1- **s' inventer
##Sentence No. 17424 - fr-ud-dev_01439
 Les 12 équipes engagées disputèrent un total de 42 matchs.
###Existing MWEs: 
1- **disputèrent matchs** (LVC)
##Sentence No. 17428 - fr-ud-dev_01443
...
###Existing MWEs: 
1- **mesures prises** (LVC), In Training Corpus
##Sentence No. 17439 - fr-ud-dev_01454
 Picotine repeint sa chaise, c'est le printemps, il fait beau.
###Existing MWEs: 
1- **il fait** (ID), In Training Corpus
###Identified MWEs: 
1- **fait beau
##Sentence No. 17440 - fr-ud-dev_01455
 5,92%, soit 90 électeurs, ont effectué un vote blanc ou nul et enfin 1173 suffrages, soit 77,12%, ont été exprimés.
###Existing MWEs: 
1- **effectué vote** (LVC)
###Identified MWEs: 
1- **effectué vote
##Sentence No. 17446 - fr-ud-dev_01461
...
###Existing MWEs: 
1- **se répète** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se répète
##Sentence No. 17450 - fr-ud-dev_01465
 Les plaines s'étendent au nord.
###Existing MWEs: 
1- **s' étendent** (IReflV)
###Identified MWEs: 
1- **s' étendent
##Sentence No. 17451 - fr-ud-dev_01466
...
###Existing MWEs: 
1- **s' échappe** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' échappe
...
###Identified MWEs: 
1- **Il vaut
##Sentence No. 17463 - fr-ud-dev_01478
...
###Existing MWEs: 
1- **font transition** (LVC)
##Sentence No. 17473 - fr-ud-dev_01488
 Le 6 mai 2011, il met un terme à sa carrière sportive.
###Existing MWEs: 
1- **met un terme** (ID), In Training Corpus
###Identified MWEs: 
1- **met un terme
...
###Existing MWEs: 
1- **marque but** (LVC), In Training Corpus
###Identified MWEs: 
1- **marque le seul
##Sentence No. 17509 - fr-ud-dev_01524
 Le Marché commun du Golfe, devant déboucher vers la mise en place d'une monnaie commune, connaît aujourd'hui des retards en raison, entre autres des divergences nées entre Ryadh et Abou Dhabi, principalement au sujet du siège de la future Banque centrale.
###Existing MWEs: 
1- **connaît retards** (LVC)
##Sentence No. 17519 - fr-ud-dev_01534
...
###Identified MWEs: 
1- **eu relations
##Sentence No. 17588 - fr-ud-test_00007
...
###Existing MWEs: 
1- **s' avère** (IReflV), In Training Corpus
###Identified MWEs: 
1- **s' avère
##Sentence No. 17637 - fr-ud-test_00056
...
###Existing MWEs: 
1- **se passe** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se passe
##Sentence No. 17640 - fr-ud-test_00059
 A chaque fois qu'il sent la pression, le Makhzen appelle quelqu'un à son secours.
###Existing MWEs: 
1- **appelle à secours** (ID), In Training Corpus
##Sentence No. 17642 - fr-ud-test_00061
 Qui a donné l'exemple ?
###Existing MWEs: 
1- **donné l' exemple** (ID)
##Sentence No. 17644 - fr-ud-test_00063
...
###Existing MWEs: 
1- **pointe le bout de son nez** (ID)
###Identified MWEs: 
1- **pointe pas bout
##Sentence No. 17651 - fr-ud-test_00070
...
###Existing MWEs: 
1- **grossir les rangs** (ID)
##Sentence No. 17664 - fr-ud-test_00083
...
###Existing MWEs: 
1- **n' en revenait pas** (ID)
##Sentence No. 17671 - fr-ud-test_00090
...
1- **réunion )
2- **se déroule
##Sentence No. 17673 - fr-ud-test_00092
 A aucun moment, du jour ou de la nuit s'il le faut.
###Existing MWEs: 
1- **il faut** (ID), In Training Corpus
###Identified MWEs: 
1- **il le faut
##Sentence No. 17678 - fr-ud-test_00097
 Il n'y en a point.
###Existing MWEs: 
1- **Il y a** (ID), In Training Corpus
###Identified MWEs: 
1- **Il y a
##Sentence No. 17679 - fr-ud-test_00098
...
###Existing MWEs: 
1- **faire valoir** (ID), In Training Corpus
###Identified MWEs: 
1- **faire valoir
##Sentence No. 17681 - fr-ud-test_00100
 La préfecture de Police de Paris déconseille aux automobilistes de se déplacer.
###Existing MWEs: 
1- **se déplacer** (IReflV), In Training Corpus
###Identified MWEs: 
1- **se déplacer
##Sentence No. 17683 - fr-ud-test_00102
...
###Existing MWEs: 
1- **en ont dans le slip** (ID)
##Sentence No. 17685 - fr-ud-test_00104
...
###Existing MWEs: 
1- **rôle jouer** (LVC), In Training Corpus
###Identified MWEs: 
1- **rôle jouer
##Sentence No. 17702 - fr-ud-test_00121
...
###Existing MWEs: 
1- **Prenant la parole** (ID)
###Identified MWEs: 
1- **Prenant la parole
##Sentence No. 17707 - fr-ud-test_00126
...
###Identified MWEs: 
1- **Il faut
##Sentence No. 17714 - fr-ud-test_00133
...
###Identified MWEs: 
1- **s' en est
##Sentence No. 17715 - fr-ud-test_00134
...
###Existing MWEs: 
1- **perdent pied** (ID)
##Sentence No. 17716 - fr-ud-test_00135
 Il y a un personnage très absent tout au long du roman, le "peuple".
###Existing MWEs: 
1- **Il y a** (ID), In Training Corpus
###Identified MWEs: 
1- **Il y a
##Sentence No. 17719 - fr-ud-test_00138
...
###Identified MWEs: 
1- **Il faut
2- **jouissant d' aisance
##Sentence No. 17733 - fr-ud-test_00152
...
###Existing MWEs: 
1- **s' apprêtent** (IReflV)
###Identified MWEs: 
1- **s' apprêtent
##Sentence No. 17745 - fr-ud-test_00164
 Fini les vacances pour le jeune Pascal Haupais qui fait sa rentrée en classe de CM1.
###Existing MWEs: 
1- **fait rentrée** (LVC), In Training Corpus
###Identified MWEs: 
1- **fait rentrée
...
###Existing MWEs: 
1- **Le ton donné** (ID)
##Sentence No. 17753 - fr-ud-test_00172
 Ça va forcément me rappeler des souvenirs.
###Existing MWEs: 
1- **me rappeler** (IReflV)
##Sentence No. 17756 - fr-ud-test_00175
...
###Existing MWEs: 
1- **l' emporter** (ID), In Training Corpus
###Identified MWEs: 
1- **l' emporter
...
###Existing MWEs: 
1- **couronner le tout** (ID), In Training Corpus
###Identified MWEs: 
1- **couronner le tout
##Sentence No. 17857 - fr-ud-test_00276
...
###Identified MWEs: 
1- **avais besoin
##Sentence No. 17868 - fr-ud-test_00287
 Trop cher, il y a des pizzeria meilleure et moins cher ;)
###Existing MWEs: 
1- **il y a** (ID), In Training Corpus
###Identified MWEs: 
1- **il y a
##Sentence No. 17873 - fr-ud-test_00292
...
###Identified MWEs: 
1- **eu besoin
##Sentence No. 17876 - fr-ud-test_00295
